### START OF CODE FROM EXTERNAL SOURCE (URL: https://github.com/khwilson/SentencingCommissionDatasets/blob/main/convert.py)
...
### END OF CODE FROM EXTERNAL SOURCE (URL: https://github.com/khwilson/SentencingCommissionDatasets/blob/main/convert.py)